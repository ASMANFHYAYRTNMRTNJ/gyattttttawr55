...
local Themes = {
    ["Dark"] = {
        ...
        TabText = Color3.fromRGB(80, 0, 255),
        ItemText = Color3.fromRGB(80, 0, 255),
        ItemUIStrokeSelected = Color3.fromRGB(80, 201, 206), --40, 50, 255
        DropdownIcon = Color3.fromRGB(80, 0, 255),
        SectionText = Color3.fromRGB(80, 0, 255),
        SelectedTabFrame = Color3.fromRGB(53, 53, 57),
    ...
    ["Tokyo Night"] = {
        ...
        Lines = Color3.fromRGB(40, 50, 255),
        ...
        ItemText = Color3.fromRGB(80, 0, 255),
        SectionText = Color3.fromRGB(80, 0, 255),
        ItemUIStrokeSelected = Color3.fromRGB(40, 50, 255),
        SelectedTabFrame = Color3.fromRGB(53, 53, 57),
        ItemFrame = Color3.fromRGB(39, 40, 57),
        HoverItemFrame = Color3.fromRGB(50, 52, 74),
        DropdownIcon = Color3.fromRGB(80, 0, 255),
        SectionUIStroke = Color3.fromRGB(40, 50, 255),
        MainUIStroke = Color3.fromRGB(40, 50, 255),
        Main = Color3.fromRGB(26, 27, 38),
        Shadow = Color3.fromRGB(26, 27, 38),
        SliderOuter = Color3.fromRGB(50, 50, 50),
        SliderInner = Color3.fromRGB(50, 50, 50),
        TabUIStroke = Color3.fromRGB(40, 50, 255),
        InputPlaceHolder = Color3.fromRGB(40, 50, 255),
        ToggleOuter = Color3.fromRGB(56, 59, 83),
        ToggleOuterEnabled = Color3.fromRGB(77, 82, 115),
        ToggleOuterUIStroke = Color3.fromRGB(40, 50, 255),
        ToggleOuterUIStrokeEnabled = Color3.fromRGB(40, 50, 255),
